...
public class Main {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		try {
            ...
            long batchTimeFrame = -1;
            String batchTimeFrameArg = prop.getProperty("comset.batch_time_frame");
            if(batchTimeFrameArg != null){
                batchTimeFrame = Long.parseLong(batchTimeFrameArg);
            }

            String algorithmFactor = prop.getProperty("comset.matching_algorithm_factor");
            if(algorithmFactor == null){
                System.out.println("The simulator class must have algorithm factor.");
                System.exit(1);
            }
			...
			simulator.configure(mapJSONFile, datasetFile, numberOfAgents, boundingPolygonKMLFile, resourceMaximumLifeTime, agentPlacementSeed, speedReduction, batchTimeFrame, algorithmFactor);
